                        ...
                        <div class="comment_form_area"@if (app()->getLocale()=='ar') style="direction: rtl" @endif>
                            ...
                            <form action="{{ route('Distributor.show',$distributor->id) }}" method="GET">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="name_ar" name="name_ar" value="{{ $distributor->name_ar }}"disabled>
                                    <span class="text-danger d-block" id="name-error"> </span>
                                </div>
                                ...
                                {{-- <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="country_id" name="country_id" value="{{ $distributor->country_id }}"disabled> {{ $countries->country_name}}
                                </div>

                                <div class="form-group col-md-6">
                                    <label>@lang('site.city')</label>
                                    <span class="text-danger" id="city_id-error"> </span>
                                    <input type="text" class="form-control" id="city_id" name="city_id" value="{{ $distributor->city_id }}"disabled>
                                </div> --}}
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="emial" name="email"  value="{{ $distributor->email }}" disabled>
                                </div>
                                ...
                                {{-- <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="core_business" id="core_business"   value="{{  $distributor->core_business }}" disabled>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <span class="text-danger" id="territory-error"> </span>
                                    <input type="text" class="form-control" id="location" name="location" value="{{ $distributor->location }}"  disabled >
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <span class="text-danger" id="address-error"> </span>
                                    <textarea class="form-control" name="address_ar" disabled>{{ $distributor->address_ar }}</textarea>
                                </div>
