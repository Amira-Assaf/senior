                        ...
                        <div class="comment_form_area"@if (app()->getLocale()=='ar') style="direction: rtl" @endif>
                            ...
                            <form action="{{ route('AdminUser.store') }}" method="POST">
                                ...
                                <div class="form-group col-md-12">
                                    <label>@lang('site.user-name')</label>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="admintab-wrap edu-tab1 mg-t-30">
                                        <label style="text-decoration: underline">@lang('site.permissions')</label>
                                    ...
                                    @foreach ($models as $index=>$model)
                                        ...
                                        {{-- <li class="{{ $index == 0 ? 'active' : '' }}"><a href="#{{ $model }}" data-toggle="tab"></li> --}}
                                    @endforeach
                                     </ul>
                                ...
                                <div class="form-group col-md-12">
                                    <button type="submit"  id="user-save" value="submit" class="form-control btn btn-info mb-2 text-white">@lang('site.submit')</button>
                                </div>
