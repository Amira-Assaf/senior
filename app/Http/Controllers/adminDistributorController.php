...
class adminDistributorController extends Controller
{
    ...
    public function index()
    {
        ...
        $distributors =distributor::where('active', 1)->where("status_id","3")->orderBy('name', 'desc') ->get();
    ...
    public function show($id)
    {
        ...
        return view("admin.view-distributor",
    ...
    public function edit($id)
    {
        ...
        //  return view("admin.edit-distributor")->with("distributor",$distributor ,"countries",$countries);
         ...
         ["distributor"=>$distributor,"Products"=> $Products,"DistributorProduct"=>$DistributorProduct,"countries"=>$countries
        ]
      ); 
    }
